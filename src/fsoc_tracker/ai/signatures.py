...
def signature_score(
    ...
    scores["freq_score"] = max(0.0, 1.0 - scores["freq_error"] / cfg.freq_tolerance)
    ...
    # aggregate (weights from Plan §6)
    agg = 0.45 * scores["blink_corr"] + 0.35 * scores["freq_score"] + 0.20 * scores["size_ok"]
